...
namespace Ecom.Infra.Data.Migrations
{
    ...
    [Migration("20240319150644_prd_nm_imagem_prop")]
    partial class prd_nm_imagem_prop
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecom.Core.Entities.PRD_Produto", b =>
                {
                    ...
                    b.Property<string>("prd_nm_imagem")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ecom.Core.Entities.PRD_Produto", b =>
                {
                    b.HasOne("Ecom.Core.Entities.CAT_Categoria", "Categoria")
                        .WithMany("Produto")
                        .HasForeignKey("prd_id_categoria")
